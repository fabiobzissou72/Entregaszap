...
// fix: Specify SVG props for the svgContent parameter to fix cloneElement typing error.
const createIcon = (svgContent: React.ReactElement<React.SVGProps<SVGSVGElement>>): React.FC<IconProps> => {
  // fix: Use default parameters for props as `defaultProps` is deprecated on React.FC components.
  const IconComponent: React.FC<IconProps> = ({ size = defaultProps.size, className = defaultProps.className }) => {
...
export const Settings = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 0 2.22l-.15.1a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1 0-2.22l.15-.1a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path><circle cx="12" cy="12" r="3"></circle></svg>
);
...
export const UserCog = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 0 2.22l-.15.1a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1 0-2.22l.15-.1a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-3.9 3.5"></path><circle cx="8" cy="7" r="4"></circle></svg>
);
...
export const TrendingDown = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 18 13.5 8.5 8.5 13.5 1 6"></polyline><polyline points="17 18 23 18 23 12"></polyline></svg>
);
...
export const Info = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
);
...
export const Car = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 16.94V18a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-1.06A8 8 0 0 1 4 9V8a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v1a8 8 0 0 1-6 7.94z"/><path d="M5.12 11h13.76"/><circle cx="7" cy="15" r="1"/><circle cx="17" cy="15" r="1"/></svg>
);
export const GasCylinder = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4.5 13.5A2.5 2.5 0 0 1 2 11V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v6a2.5 2.5 0 0 1-2.5 2.5Z"/><path d="M8 3V2a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v1"/><path d="M12 13.5V19a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-5.5"/><path d="M2 11h20"/></svg>
);
export const Motorcycle = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="6.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/><path d="M12 18h-2.5L7 14h2l2 4Z"/><path d="m14 4-2 2h3l2-3h-3L12 5V2.5"/><path d="m11.5 14-2.5-2.5-2-3 2.5-3 4.5 2 2 3-2.5 2.5-2.5 1Z"/><path d="M8 8.5 14.5 5l-2.5 6.5"/></svg>
);
...
export const Palette = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.424-.16-.832-.435-1.157-.275-.325-.355-.76-.234-1.15.12-.39.423-.69.776-.82.353-.13.736-.05.99.2.253.25.626.39.996.39.926 0 1.667-.746 1.667-1.667 0-.424-.16-.832-.435-1.157-.275-.325-.355-.76-.234-1.15.12-.39.423-.69.776-.82.353-.13.736-.05.99.2.253.25.626.39.996.39.926 0 1.667-.746 1.667-1.667S21.476 2 20.55 2c-.926 0-1.667.746-1.667 1.667 0 .424.16.832.435 1.157.275.325.355.76.234 1.15-.12.39-.423.69-.776.82-.353.13-.736.05-.99-.2-.253-.25-.626-.39-.996-.39-.926 0-1.667.746-1.667 1.667 0 .424.16.832.435 1.157.275.325.355.76.234 1.15-.12.39-.423.69-.776.82-.353.13-.736.05-.99-.2-.253-.25-.626-.39-.996-.39A1.667 1.667 0 0 1 12 8.333a1.667 1.667 0 0 1-1.667-1.666 1.667 1.667 0 0 1 1.667-1.667c.925 0 1.667.746 1.667 1.667 0 .424-.16.832-.435 1.157-.275.325-.355-.76-.234-1.15.12-.39.423-.69.776-.82.353-.13.736-.05.99.2.253.25.626.39.996.39.926 0 1.667-.746 1.667-1.667A1.667 1.667 0 0 0 12 2Z"/></svg>
);
...
// These icons were not used in the initial code but might be useful. Keeping them for completeness.
...
export const ArrowUpDown = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m21 16-4 4-4-4"/><path d="M17 20V4"/><path d="m3 8 4-4 4 4"/><path d="M7 4v16"/></svg>
);
